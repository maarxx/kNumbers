namespace Numbers
{
    ...
    public class PawnColumnWorker_Bleedrate : PawnColumnWorker_Text
    {
        ...
        protected override string GetTextFor(Pawn pawn) => pawn.health.hediffSet.BleedRateTotal.ToStringPercent();
        ...
        private Color FindPrettyColourForBleedingPawn(Pawn pawn)
        {
            ...
            return Mathf.Approximately(isThisMyBlood, 1f) ? SeverePainColor : HealthUtility.DarkRedColor;
        }
    }
}
