...
namespace Numbers
{
    ...
    public class PawnColumnWorker_PrisonerRecruitmentDifficulty : PawnColumnWorker_Text
    {
        ...
        {
            return pawn.RecruitDifficulty(Faction.OfPlayer).ToStringPercent();
        }

        public override int Compare(Pawn a, Pawn b)
        {
            return a.RecruitDifficulty(Faction.OfPlayer).CompareTo(b.RecruitDifficulty(Faction.OfPlayer));
        }
